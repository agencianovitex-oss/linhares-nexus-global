...
const content: Record<Locale, PageContent> = {
  pt: {
    ...
    featured: [
      ...
      { title: "Top of Business 2026 · Homenagem em Roma", year: "2026", institution: "International Business Institute", description: "Em Roma, o Dr. André Linhares foi homenageado no Top of Business 2026 pelo International Business Institute, reconhecendo sua trajetória de excelência nos ambientes corporativo e jurídico.", image: topBusiness },
    ],
    textual: [
  ...
  en: {
    ...
    featured: [
      ...
      { title: "Top of Business 2026 · Honoree in Rome", year: "2026", institution: "International Business Institute", description: "In Rome, André Linhares was honored at Top of Business 2026 by the International Business Institute, recognizing his trajectory of excellence in the corporate and legal fields.", image: topBusiness },
    ],
    textual: [
  ...
  es: {
    ...
    featured: [
      ...
      { title: "Top of Business 2026 · Homenaje en Roma", year: "2026", institution: "International Business Institute", description: "En Roma, André Linhares fue homenajeado en Top of Business 2026 por el International Business Institute, reconociendo su trayectoria de excelencia en los ámbitos corporativo y jurídico.", image: topBusiness },
    ],
    textual: [
