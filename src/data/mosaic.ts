...
export const mosaicPhotos: MosaicPhoto[] = [
  { src: p104.url, alt: "Cliente do Linhares Law recebendo seu Green Card" },
  { src: p108.url, alt: "Dr. André Linhares entregando Green Card a cliente" },
  { src: p109.url, alt: "Clientes do Linhares Law com Green Cards aprovados" },
  ...
  { src: p112.url, alt: "Cliente do Linhares Law com Green Card em mãos" },
  { src: p113.url, alt: "Comemoração de aprovação de Green Card no Linhares Law" },
  { src: p114.url, alt: "Clientes do Linhares Law recebendo Green Cards" },
  { src: p105.url, alt: "Dr. André Linhares com clientes aprovados no Green Card" },
  { src: p106.url, alt: "Cliente do Linhares Law recebendo Green Cards" },
];
