...
import { Bold, Italic, List, ListOrdered, Heading2, Heading3, Quote, Link2, Image as ImageIcon, Minus, Code } from "lucide-react";
...
export function TipTapEditor({ value, onChange, placeholder }: Props) {
  ...
  return (
    <div className="border border-input bg-white">
      <div className="flex flex-wrap gap-0 border-b border-border bg-muted/30">
