...
export const dict = {
  pt: {
    ...
    pages: {
      home: { title: "Linhares Law", intro: "Um escritório boutique de imigração americana, com presença institucional em Orlando, Miami, New York e Salt Lake City." },
      about: { title: "Quem Somos", intro: "Uma prática boutique fundamentada em rigor jurídico, discrição e atendimento personalizado." },
      services: { title: "Serviços", intro: "Estratégias de imigração para profissionais, executivos, investidores e famílias internacionais." },
      team: { title: "Equipe", intro: "Advogados e profissionais dedicados a representar trajetórias de excelência." },
      awards: { title: "Premiações", intro: "Reconhecimentos institucionais que refletem nossa reputação e consistência." },
      media: { title: "Na Mídia", intro: "Aparições, entrevistas e contribuições editoriais em veículos relevantes." },
      success: { title: "Casos de Sucesso", intro: "Histórias representativas de aprovações e trajetórias conquistadas." },
      blog: { title: "Publicações", intro: "Análises, atualizações regulatórias e perspectivas institucionais." },
